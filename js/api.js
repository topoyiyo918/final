...
function myFunction() {
  ...
  for (let i = 6; i > 0; i--) {
    ...
    if (i > 1) {
    alert("Oprima el boton " +(i-1)+ " veces mas para comprobar que no es un robot");
    console.log("Oprima el boton " +(i-1)+ " veces mas para comprobar que no es un robot");    
  }else{
    alert("Registro exitoso");
    console.log("Ya puede realizar su registro");
  }    
  }    
} 